    ...
    initializeUser() {
      ...
      onAuthStateChanged(auth, (user) => {
        if (user) {
          ...
          } else if (user.email === 'cristinadelgadogonzalvez@gmail.com' || user.email === 'nacho.victoria.sanes77@gmail.com') {
            this.user = 4; // Usuario autenticado pero no es el administrador
          }
